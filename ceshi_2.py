...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(360, 320)
        Form.setStyleSheet("\n"
                           "background-image: url(:/imgae/jiemian.png);")
    ...
    def retranslateUi(self, Form):
        ...
        self.fuwei.setText(_translate("Form", "复位"))
        self.yunduan.setText(_translate("Form", "云端"))
        self.bendi.setText(_translate("Form", "本地"))
